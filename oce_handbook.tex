...
\newcommand{\fixme}[1]{\color{blue}$<$#1$>$\color{black}\index{$>>>>$FIXME$<<<<$}}

\newcommand{\curcom}{\index{Committees!Curriculum}Curriculum Committee}

\newcommand{\advcom}{\index{Committees!Advisory}Advisory Committee}

\newcommand{\goc}{\index{Committees!Graduate Oversight}Graduate Oversight Committee}
...
the Academic Timetable on the Registrar’s Office
website\footnote{\href{https://dalonline.dal.ca/PROD/fysktime.P_DisplaySchedule}{Academic
Timetable} as ``Registration Course--Graduate''.}.
...
made\footnote{Graduate Student Program Forms can be downloaded from the
\href{http://www.dal.ca/faculty/gradstudies/currentstudents/forms.html}{FGS
website}.}.  Failure to do so can result in the assessment of additional fees
for courses not included in your program requirements, or affect the student’s
ability to graduate.
