...
\begin{quotation}
``Students must complete \course{5001} and an additional 6 credit hours from
...
\fixme{ask LL: what about the rule on adv-placement or waiving? We
should provide a URL and summary statement}
...
months of their transfer.\fixme{I'm lost in my notes on the suggested new rules
on timing. We may have decided ``between 8 and 20 months of finishing core
classes'' LORI -- is this in your notes?}

\p The \qe Examining Committee includes a Chair (normally the \GC or a
designate who is not associated with the student), at least three members of
the subdiscipline, including the \supervisor, and an External Examiner drawn
from the Oceanography faculty outside the sub-discipline(s).  It is the
\supervisor's responsibility to set up this committee and to arrange the timing
of the \qe.
