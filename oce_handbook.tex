...
methods. This should be under 15 pages of text, double-spaced and inclusive of
...
of their \supcom.  Such defences \replace{normally}{will} occur during a meeting of the
...
\begin{enumerate}
    ...
    \item All members of the \supcom must approval of a thesis before its
    ...
    \item \fixme{Insert a statement here about remote participation (allowed?
        who sets it up? who judges when to cut the cord?) or, recognizing the
        changing facts of technology, avoid bringing up this topic}
...
for suitability and final approval.

\fixme{LL will rewrite the rest of this section; DK can help}
...
\fixme{ask LL: what about the rule on adv-placement?}
