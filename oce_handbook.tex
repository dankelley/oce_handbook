...
\p This report is made with the \di{Graduate Student Information System} (GSIS)
...
\p The supervisor will select a provisional committee, in consultation with the
...
\p Any student who anticipates a \di{transfer from the MSc program to the PhD
...
\p A request to \di{transfer from the MSc program to the PhD program} should be
...
\p Scholarship support is provided directly to some students by the \di{Natural
