...
\newcommand{\gocom}{\index{Committees!Graduate Oversight}\color{diColor}Graduate Oversight Committee\color{black}\xspace}

\newcommand{\FGS}{\index{Faculty of Graduate Studies (FGS)}FGS}
...
\p A \di{Graduate Student Program Form} must be submitted to the Graduate
Secretary within one month of the start of your program.  Students must submit
a \di{Graduate Student Program Update Form} to the Graduate Secretary when a
decision to make changes to course requirements is made\footnote{Graduate
Student Program Forms can be downloaded from the FGS website
...
submit a \index{forms!sea time}\di{Sea Time Form} to the Graduate Secretary
after completion of this requirement, and the \curcom must approve completed
forms.
...
\p Following approval of the \di{research proposal} by the \advcom, the student
should have several meetings in addition to the regular committee meetings as
follows:
...
\item Approval of research plan and direction for \di{thesis proposal}.
\item Acceptance of a \di{thesis proposal}.
...
approved proposal must be placed on file with the Graduate Secretary. MSc
students may be required to defend the research proposal at the discretion of
their committee.
...
anniversary of the student's admission date. The \gocom will then review the
request.
...
with your Chair, Graduate Coordinator, or Supervisor, or contact the Faculty of
