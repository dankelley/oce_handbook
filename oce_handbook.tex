...
\author{}
\date{takes into account Boudreau's comments dated 2017-03-21}
...
\begin{itemize}
    ...
    \item ``CRN'' refers to a Course Registration Number. For example, the
        ...
        Calendar, has CRN 12070. Consult the Academic Calendar\furl{https://dalonline.dal.ca/PROD/fysktime.P_DisplaySchedule?s_term=201710,201720&s_subj=OCEA&s_district=100} for more information.
    ...
    \item ``External,'' referring to a person, is employed in this document in
        ...
        \begin{enumerate}
            ...
            \item For the purposes of an MSc defence, ``external'' refers to a
                person who has not been a member of the student's advisory
                committee (at any time).\discuss{Why "at any time"? Has this
                been a problem in the past? It might cause difficulties if we
                start assigning provisional supervisory committees (which might
                be a way we can get things on track early).}  Such a person may
                be a Department faculty member, a faculty member from another
                Department, or an Adjunct from outside the University.  This
                person must have FGS status\cref{footnote:adjunct}.
...
Studies. Registration involves registering for a ``course'' named ``Registration
...
least 1 month prior to the beginning of a term will result in delayed payment of
...
\p In addition to \course[REGN]{9999}, 
...
help students gain a broad understanding of the major areas of Oceanography.
They are offered every year, typically with Physical and Chemical in the 
Fall term, to set the stage for Geological and Biological in the Winter term.
...
year. Details of offerings are available online\furl{https://dalonline.dal.ca/PROD/fysktime.P_DisplaySchedule?s_term=201710,201720&s_subj=OCEA&s_district=100}.
...
stream of any courses that are cross-listed to the 4000 levels (see
...
Calendar for deadlines\furl{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=58&chapterid=2677}.
...
apply, in writing, to the department for immediate reinstatement~\cav{5.4.1}{Reinstatement of Students}{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=58&chapterid=2678&topicgroupid=10848}.
...
the class is not available at Dalhousie\cav{7.6.6}{Letters of Permission}{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=58&chapterid=2678&topicgroupid=10850}.
The Letter of Permission, available at the \FGS
website\cref{footnote:fgs_forms},
...
it can be subject to failure if a message goes missing, so students are advised
to check the status of these reports on \dalonline after they submit
them.\fixme{Can students check that? I phoned LL to ask}
...
Report\furl{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=58&chapterid=2678&topicgroupid=10850}.\fixme{I don't think we should state this ``along with''}
...
\item In consultation with the student and \supervisor, select \advcom
...
website\furl{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=2&chapterid=399&topicgroupid=1435}. \fixme{Link seems to have changed over the past few months.}
...
members, according to the guidelines stated below. Note that short-term absence
of members of the \advcom are not a sufficient reason to schedule a defence in
violation of these guidelines.\vote{DK: I rewrote some of this because the text
was a mish-mash, as BB pointed out. Are the few lines before and after this OK?
DK=yes}
...
\begin{itemize}
    \item All members of the advisory committee\vote{In the previous version,
...
\vote{DK to GOC: I had suggested removing the material below if it's on \FGS,
but BB suggested keeping it, so it is still here. OK? DK=yes, BB=yes}
    ...
    \item Following a successful Defence:
        ...
        \begin{itemize}
            ...
            \item Have Examining Committee Members sign the signature
                page.\fixme{ask LL: does such a form still exist? Both DK and
                BB think it does not.}
            ...
            \item Submit original completed forms to \FGS (National Library of
                ...
                Student Contribution to Manuscripts (if applicable).\fixme{Ask
                LL: do these things all still exist?}
            ...
            \item Submit final copies of thesis to the \GS for binding (include
                ...
                with original signatures).\fixme{Ask LL: check with \FGS
                on all of this. For example, I don't think signatures are part
                of a thesis anymore, owing to privacy issues.}\vote{DK to GOC:
                should we keep the binding requirement? If the department wants
                copies, why doesn't it print them and bind them. The archival copy is
                a PDF that is on the web, after all.}
...
requirement. For students with an MSc from other departments or institutions:
core course equivalencies will be assessed by the \gocom on a case-by-case
basis. Additional courses may be required to strengthen a student’s
background.\vote{DK to GOC: I removed ``in basic science'' from AM's text,
since it doesn't mean much and is incorrect, since the courses are often
advanced. OK? DK=yes, BB=yes}.
...
\p The \advcom must be formed within the first month of the program.

\p The PhD \advcom consists of at least four members. There must be two
full-time faculty members from the Oceanography Department (not Adjunct FGS) on
the \advcom. If a regular faculty member serving on the committee leaves the
department, a replacement with another faculty member must be made.
...
have this exception correct? BB says "yes".}
...
granted by the CurrComm? BB answers "no"}
...
and \advcom, completed a \QE, and received approval from the \supervisor.\fixme{I added the QE part, on advice of BB}
...
committee. The Departmental Representative or a designate normally performs
this duty.

\p Students must make the \index{thesis proposal} proposal available in the
Department of Oceanography office at least 10 working days prior to the oral
defence\vote{DK to GOC: I think we should have a form for this. OK? DK=yes,
BB=yes}  The proposal typically receives input from the \supervisor or others
prior to its submission. Approval from the \advcom is required to proceed with
the oral defence.
...
\p Students should discuss any additional employment with their \advcom to
...
\p The University specifies
guidelines~\cav{6}{Intellectual Property and Conflict of Interest}{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=58&chapterid=2678&topicgroupid=10849}
on \di{intellectual property}, \di{conflict of interest}, \di{intellectual
honesty}, \di{plagiarism}, \di{scholarly integrity}, \etc, and students are
expected to be familiar with and follow these policies.
...
\p The Panel does not have fixed membership.  Instead, it will consist of
\sout{three} two \fixme{change from BB} faculty members, chosen on a fixed
rotating basis from all the faculty in the Department.  The professor(s)
responsible for the process being appealed will be excluded.  For graduate
students, the student's \supervisor or co-supervisors, or for undergraduates,
the student's honors supervisor (if applicable) will also be excluded from the
list.
...
\p \sout{The Panel will examine the appeal and determine if a \emph{prima
...
If such a case exists, then the} A panel will convene a formal Appeal Hearing
at the first opportunity when all involved, i.e., appellant, the faculty member
...
\sout{If there is no \emph{prima facie} case, the Panel will inform the Chair
and the appeal will be dismissed at the Departmental level.} \fixme{Changes in
this paragraph are from BB}

\p If a Hearing is convened, The \fixme{DK to BB: why is it "The" here?} Panel
will chose a Chair who will control and direct all communication.
...
written rebuttal to the appeal within \sout{5} 10 working days of the appeal
being received.  (Exceptions will be made to accommodate persons being at sea
or subject to other serious limitations in availability.)  The Panel will
forward that rebuttal to the appellant. \fixme{the change is from BB}
