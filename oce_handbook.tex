...
\p Students must register for the 5xxx stream of any courses that are
...
\fixme{the meeting on 2017-04-10 will address this section in the context of the FGS rules}
...
\supervisor and \supcom. The scope of the research should be such that the
...
and \supcom, completed a \QE, and received approval from the \supervisor.\fixme{I added the QE part, on advice of BB}
...
prior to its submission. Approval from the \supcom is required to proceed with
the oral defence.
