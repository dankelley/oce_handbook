...
\begin{itemize}
    ...
    \item Approval of research plan and direction for thesis proposal (see
        ...
        and~\ref{sec:phd_thesis_proposal}. \fixme{DK to GOC: my notes suggest
        deleting this item, but I suggest keeping it. Is that ok?}
...
inclusive of diagrams and citations.\fixme{DK to GOC: I made the length more
specific. OK?}
...
approval is granted, the students must fill in a student update
form to indicate the change of program.\fixme{DK: I will give a URL for that
form. Also, I'll check with Lori on whether the students do this, or whether
she does it after students hand in a paper form}
