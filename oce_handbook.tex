...
\definecolor{diColor}{rgb}{0,0,0.8} % hide them as black
...
Students must register for the Fee Generating
...
The \di{Course Registration Number} (\di{CRN}) for each term can be found in
the Academic Timetable on the Registrar's Office website\footnote{Academic
