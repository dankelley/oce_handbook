...
\newcommand{\NSERC}{\index{Natural Sciences and Engineering Research Canada (\textsc{nserc})}\color{diColor}NSERC\color{black}\xspace}
...
readmission (see \furl[FGS V. Registration Procedures and Regulations]{http://academiccalendar.dal.ca/Catalog/ViewCatalog.aspx?pageid=viewcatalog&catalogid=58&chapterid=2678&topicgroupid=10848}).
    ...
    \item The Exam:
        ...
        \begin{itemize}
            ...
            \item The entire exam should last no longer than 1.5 hours.\vote{DK
                ...
                even with just for one round.  I propose we state 2.5 hours for
                the non-in-camera part . OK?}
...
defence\vote{DK to GOC: I think we should have a form for this. OK?}  The
proposal typically receives input from the \supervisor or others prior to its
...
individual faculty members' research grants, with a minor contribution from
\FGS.
...
\p Students should discuss any additional jobs with their \advcom to ensure
that the time commitments outside the Department are not excessive, and do not
interfere with program expectations. (The university also imposes limits on
...
Departmental approval must be given to these applications\discuss{DK to LL: do
we actually approve these?}.
